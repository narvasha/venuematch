...
export default function VenueOwnerProfileEdit() {
  ...
  useEffect(() => {
    axios
      .get(`https://kritisubedi.com.np/SnTravels/api/index//user-data`, {
        headers: {
          api_key: `${Cookies.get("apikey")}`,
        },
      })
  ...
  const deleteAccount = async () => {
    ...
    try {
      ...
      const response = await axios.delete(
        "https://kritisubedi.com.np/SnTravels/api/index//delete-my-account",
        {
          headers: {
            api_key: Cookies.get("apikey"),
          },
