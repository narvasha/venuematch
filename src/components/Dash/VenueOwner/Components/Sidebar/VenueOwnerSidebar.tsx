        ...
        <div className={classes.collections}>
          <Link to="/my-venues">
            <div className={classes.collectionLink}>
              ...
              <span style={{ marginLeft: "10px" }}>My Venues</span>
            </div>
          </Link>
          <Link to="/my-dishes">
            <div className={classes.collectionLink}>
            <FontAwesomeIcon icon={faBowlFood}className="sideIcon" style={{}}/>
              <span style={{ marginLeft: "10px" }}>My Dishes</span>
            </div>
          </Link>
          <Link to="/my-venue-bookings">
            <div className={classes.collectionLink}>
              <IconCreditCard className="sideIcon" />
              <span style={{ marginLeft: "10px" }}>My Venue Bookings</span>
            </div>
          </Link>
        </div>
        <Group className={classes.collectionsHeader} position="apart">
