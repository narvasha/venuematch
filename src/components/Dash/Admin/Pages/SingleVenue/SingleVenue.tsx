...
export default function SingleVenue() {
  ...
  const vegdishes = data?.data?.venues?.[0]?.dishes?.map(
    (dish: any, index: any) => (
      <Badge
        key={`veg_${index}`} // Assign a unique key using index
        variant="outline"
        mr={5}
  ...
  const nonvegdishes = data?.data?.venues?.[0]?.dishes?.map(
    (dish: any, index: any) => (
      <Badge
        key={`nonveg_${index}`} // Assign a unique key using index
        variant="outline"
        mr={5}
        style={{
  ...
  const dessert = data?.data?.venues?.[0]?.dishes?.map(
    (dish: any, index: any) => (
      <Badge
        key={`dessert_${index}`} // Assign a unique key using index
        variant="outline"
        mr={5}
        style={{
