...
export default function GetInTouch() {
  return (
    ...
    <div className="container">
        <div className="row aos-init" data-aos="fade-up">
            <div className="col-xl-7 col-lg-7 col-md-7 col-sm-12">
                <div className="gallery_content">
                   <figure className="contact-form-img">
                       <img src="../src/assets/couple1.png" alt="" className="img-fluid"/>
                   </figure>
            ...
            <div className="col-xl-5 col-lg-5 col-md-5 col-sm-12">
                <div className="gallery_content gallery_content-mb">
                    <figure className="contact-form-img">
                        <img src="../src/assets/pokharaGrande2.png" alt="" className="img-fluid"/>
                    </figure>
                     <div className="banner-btn discover-btn-banner">
                         <Link to="#" className="text-decoration-none">Venue Match</Link>
                     </div>
                 ...
                 <figure className="gallery-img3">
                    <img src="../src/assets/siris.png" alt="" className="img-fluid"/>
                </figure>
            </div>
        </div>
        {/* <!-- row2 --> */}
        <div className="row aos-init" data-aos="fade-up">
            <div className="col-xl-4 col-lg-4 col-md-4 col-sm-6">
                <div className="gallery_content">
                   <figure className="contact-form-img">
                       <img src="../src/assets/susmita.png" alt="" className="img-fluid"/>
                   </figure>
                    <div className="banner-btn discover-btn-banner">
                        <Link to="#" className="text-decoration-none">Venue Match</Link>
                    </div>
            ...
            <div className="col-xl-4 col-lg-4 col-md-4 col-sm-6">
                <div className="gallery_content gallery_content-mb gallery-bottom">
                    <figure className="contact-form-img">
                        <img src="../src/assets/arya.png" alt="" className="img-fluid"/>
                    </figure>
                     <div className="banner-btn discover-btn-banner">
                         <Link to="#" className="text-decoration-none">Venue Match</Link>
                     </div>
            ...
            <div className="col-xl-4 col-lg-4 col-md-4 col-sm-6">
                <div className="gallery_content gallery_content-mb">
                    <figure className="contact-form-img">
                        <img src="../src/assets/anup.png" alt="" className="img-fluid"/>
                    </figure>
                     <div className="banner-btn discover-btn-banner">
                         <Link to="#" className="text-decoration-none">Venue Match</Link>
                     </div>
    ...
    <figure className="gallery-design-img">
        <img src="../src/assets/gallery-design-img.png" alt=""/>
    </figure>
</div>
  )
}
